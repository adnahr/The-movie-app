...
export const API_URLS = {
	...
	SEARCH_TV_SHOW: (search: string) =>
		`https://api.themoviedb.org/3/search/tv/?query=${search}&api_key=${API_KEY}`,
	SEARCH_MOVIE: (search: string) =>
		`https://api.themoviedb.org/3/search/movie/?query=${search}&api_key=${API_KEY}`,
	TV_SHOW: (search: string) =>
		`https://api.themoviedb.org/3/tv/${search}?api_key=${API_KEY}`,
	MOVIE: (search: string) =>
		`https://api.themoviedb.org/3/movie/${search}?api_key=${API_KEY}`,
};
